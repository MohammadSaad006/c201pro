...
heading_label = Label(window, text="Simple Interest Calculator", fg="#F0FFFF", bg="blue", font=("Calibri",20), bd=5)
heading_label.place(x=50, y=20)

principal_label=Label(window, text="Principal ", fg="blue", bg="#F0FFFF", bd=5, font=("Calibri",15))
principal_label.place(x=30, y=120)
principal_entry = Entry(window, text="", bd=2, width=23)
principal_entry.place(x=148, y=127)

rate_label=Label(window, text="Rate ", fg="blue", bg="#F0FFFF", bd=5, font=("Calibri",15))
rate_label.place(x=30, y=170)
rate_entry = Entry(window, text="", bd=2, width=23)
rate_entry.place(x=148, y=177)

time_label=Label(window, text="Time (year)", fg="blue", bg="#F0FFFF", bd=5, font=("Calibri",15))
time_label.place(x=30, y=220)
time_entry = Entry(window, text="", bd=2, width=23)
time_entry.place(x=148, y=227)

calculate_button = Button(window, text="CALCULATE", fg="blue", bg="#F0FFFF", bd=4, command=simple_interest)
calculate_button.place(x=280, y=300)

result_frame = LabelFrame(window, text="Result", bg="blue", font=("Calibri", 16))
result_frame.pack(padx=20, pady=20)
result_frame.place(x=30, y=350)

show_label = Label(result_frame, text="Your result will be displayed here", bg="#F0FFFF", fg="blue", font=("Calibri", 14), width=55)
